...
Revision May 18, 2017
... Change data source from Yahoo to Google
... Converted to Python 3
... Comply with changes to Pandas 0.19.0 for DataReader function
... Comply with changes to random 9.6 for randint function
... Casting integers where required
...
#  uncomment to enable inline plotting in jupyter notebook
#%matplotlib inline
