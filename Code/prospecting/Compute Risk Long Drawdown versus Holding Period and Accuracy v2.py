...
#hold_days = 5
drawdown_output_list = []
# drawdown_output_list.append(["Hold days","DD95","Sys_accuracy"])
...
for hold_days in hold_days_list:
    ...
    while not done:
        ...
        # write output
        drawdown_output_list.append([hold_days,DD_95,system_accuracy])
        
        # increment system accuracy
...
filename = issue +  '_drawdown_vs_risk_' + datetime.now().strftime("%Y-%m-%d-%H-%M-%S")+".csv"
np.savetxt(filename, drawdown_output_list, delimiter=',',header="Hold days,DD95,Sys_accuracy", fmt='%16.2f')
