...
for hold_days in hold_days_list:
    ...
    while not done:
        ...
        # write output
        CAR_output_list.append([hold_days,CAR_25,system_accuracy])
...
filename = issue +  '_CAR_vs_holding_vs_accuracy_' + datetime.now().strftime("%Y-%m-%d-%H-%M-%S")+".csv"
np.savetxt(filename, CAR_output_list, delimiter=',',header="Hold days,CAR25,Sys_accuracy", fmt='%16.2f')
