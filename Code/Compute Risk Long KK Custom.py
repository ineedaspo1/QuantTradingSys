...
issue = input('Enter symbol:')
data_source = 'morningstar'
start_date = datetime(2001,1,1)
end_date = datetime(2015,1,1)

hold_days = 1
system_accuracy = 0.65
DD95_limit = 0.15
initial_equity = 100000.0
fraction = 1.00
forecast_horizon = 5*252 #  trading days
number_forecasts = 100  # Number of simulated forecasts
...
dirext = issue + '_holddays' + str(hold_days) + '_accuracy' + str(system_accuracy)\
...
final_directory = os.path.join(current_directory, dirext)
...
np.savetxt(final_directory+"\\"+filename, account_balance, delimiter=',')
