...
Compute Long risk reading stock price data from disk
"""
...
hold_days = 1
system_accuracy = 0.75
DD95_limit = 0.15
initial_equity = 100000.0
fraction = 1.00
forecast_horizon = hold_days*252 #  trading days
...
filename = 'etf screener_SHORT' + filenameext
