...
#    pivotDate = datetime.strptime(pivotDate, '%Y-%m-%d')
    ...
    #  Status variables
    tradesDataFull = tradesDataFull[['Open',
                                      'Close',
                                      'gainAhead',
                                      'beLong',
                                      'valBeLong',
    ...
    for i in range (1,ndays):
        ...
        if datesPass:
            ...
            print("===")
            print("Trade day: ", iTradeDay)
            print("Date: ", dt)
            print("valBeLong: ", tradesDataFull.valBeLong[i])
            print("===")
            if sharesHeld[iTradeDay-1] > 0:
                ...
                if tradesDataFull.valBeLong[i]<0:
                    ...
                    print("Account balance: ", accountBalance[iTradeDay])
                    ...
                    print("Trade gain: ", (((exitPrice / (1.0 * entryPrice))*fixedTradeDollars)-fixedTradeDollars))
                    
                    pass
                else:
                    #  target is +1 -- beLong
                    #  Continue long
                    print("Continue Long position")
                ...
                if tradesDataFull.valBeLong[i]>0:
                    ...
                    print("Shares: ", sharesHeld[iTradeDay])
                    shareCost = sharesHeld[iTradeDay]*(entryPrice+commission)
                    print("Shares cost: ", shareCost)
